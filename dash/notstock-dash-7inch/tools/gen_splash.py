...
def main():
    ...
    # uint16_t, not bytes: boot_anim.c reads the pixels as 16-bit words, and
    # a byte array carries no alignment guarantee
    out = ["/* Generated by tools/gen_splash.py from assets/splash.png.",
           " * Do not edit by hand. RGB565, native byte order. */",
           '#include "ui.h"', "",
           f"static const uint16_t splash_logo_map[{w*h}] = {{"]
    for row in v:
    ...
    out += ["};",
            ...
            f"    .data_size = {w*h*2},",
            "    .data = (const uint8_t *)splash_logo_map,",
            "};", ""]
